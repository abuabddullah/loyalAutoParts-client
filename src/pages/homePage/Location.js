        ...
        <section class="text-gray-600 body-font relative">
            ...
            <div class="container px-5 py-24 mx-auto flex">
                <div class="lg:w-1/3 md:w-1/2 bg-white rounded-lg p-8 flex flex-col md:ml-auto w-full mt-10 md:mt-0 relative z-10 shadow-md">
                    <h2 class="sm:text-3xl text-2xl font-medium title-font mb-4 text-secondary">Our Location</h2>
                    <address class="leading-relaxed mb-5 text-gray-600">
                        <p>Vill : Fukutia</p>
                        <p>P/O : Dhamrai</p>
                    ...
                    <p class="text-xs text-secondary mt-3">ride loylty of your cars . . .</p>
                </div>
            </div>
        </section>
    );
