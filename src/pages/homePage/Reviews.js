                ...
                <div className=" -m-4 text-center">
                    ...
                    <div className="flex max-w-md mx-auto overflow-hidden bg-white rounded-lg shadow-lg dark:bg-gray-800 mb-8">
                        ...
                        <div className="w-2/3 p-4 md:p-4">
                            ...
                            <p className="mt-2 text-sm text-gray-600 dark:text-gray-400">Comments Comments Comments Comments Comments </p>

                            <div className="flex mt-2 item-center justify-center">
                                <svg className="w-5 h-5 text-primary fill-current dark:text-gray-300" viewBox="0 0 24 24">
