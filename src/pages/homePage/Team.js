        ...
        <section className="bg-white dark:bg-gray-900">
            <div className="container px-6 py-10 mx-auto">
                ...
                <div className="grid grid-cols-1 gap-8 mt-8 xl:mt-16 md:grid-cols-2 xl:grid-cols-2">
                    <div className="px-12 py-8 transition-colors duration-200 transform border cursor-pointer rounded-xl hover:border-transparent group hover:bg-secondary dark:border-gray-700 dark:hover:border-transparent">
                        <div className="flex flex-col sm:-mx-4 sm:flex-row">
                            <img className="flex-shrink-0 object-cover w-24 h-24 rounded-full sm:mx-4 ring-4 ring-gray-300" src="https://images.unsplash.com/photo-1535713875002-d1d0cf377fde?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=880&q=80" alt="" />
                                ...
                                <div className="mt-4 sm:mx-4 sm:mt-0">
                                    ...
                                    <p className="mt-2 text-gray-500 capitalize dark:text-white group-hover:text-white">design director</p>
                                </div>
                        </div>
                        ...
                        <div className="flex flex-col sm:-mx-4 sm:flex-row">
                            <img className="flex-shrink-0 object-cover w-24 h-24 rounded-full sm:mx-4 ring-4 ring-gray-300" src="https://images.unsplash.com/photo-1535713875002-d1d0cf377fde?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=880&q=80" alt="" />
                                ...
                                <div className="mt-4 sm:mx-4 sm:mt-0">
                                    ...
                                    <p className="mt-2 text-gray-500 capitalize dark:text-white group-hover:text-white">Lead Developer</p>
                                </div>
                        </div>
                        ...
                        <div className="flex flex-col sm:-mx-4 sm:flex-row">
                            <img className="flex-shrink-0 object-cover w-24 h-24 rounded-full sm:mx-4 ring-4 ring-gray-300" src="https://images.unsplash.com/photo-1535713875002-d1d0cf377fde?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=880&q=80" alt="" />
                                ...
                                <div className="mt-4 sm:mx-4 sm:mt-0">
                                    ...
                                    <p className="mt-2 text-gray-500 capitalize dark:text-white group-hover:text-white">Lead designer</p>
                                </div>
                        </div>
                        ...
                        <div className="flex flex-col sm:-mx-4 sm:flex-row">
                            <img className="flex-shrink-0 object-cover w-24 h-24 rounded-full sm:mx-4 ring-4 ring-gray-300" src="https://images.unsplash.com/photo-1570295999919-56ceb5ecca61?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=880&q=80" alt="" />
                                ...
                                <div className="mt-4 sm:mx-4 sm:mt-0">
                                    ...
                                    <p className="mt-2 text-gray-500 capitalize dark:text-white group-hover:text-white">Full stack developer</p>
                                </div>
                        </div>
