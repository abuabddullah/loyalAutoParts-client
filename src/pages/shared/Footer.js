...
const Footer = () => {
    return (
        <footer className="text-gray-600 body-font footerBG border-t-[1px]">
                ...
                <div className="flex flex-wrap md:text-left text-center order-first">
                    <div className="lg:w-1/4 md:w-1/2 w-full px-4">
                        ...
                        <nav className="list-none mb-10">
                            ...
                            <li>
                                <Link to="/blogs" className="text-gray-600 hover:text-gray-800">Second Link</Link>
                            </li>
                            <li>
                                <Link to="/register" className="text-gray-600 hover:text-gray-800">Register</Link>
                            </li>
                            <li>
                                <Link to="/" className="text-gray-600 hover:text-gray-800">Items</Link>
                            </li>
                        </nav>
                    </div>
                    <div className="lg:w-1/4 md:w-1/2 w-full px-4">
                        ...
                        <nav className="list-none mb-10">
                            <li>
                                <span className="text-gray-600 hover:text-gray-800">Bangladesh</span>
                            </li>
                            <li>
                                <span className="text-gray-600 hover:text-gray-800">+880-1939032974</span>
                            </li>
                            <li>
                                <Link to="/" className="text-gray-600 hover:text-gray-800">asif@mail.kr</Link>
                            </li>
                        </nav>
                    </div>
                    <div className="lg:w-1/4 md:w-1/2 w-full px-4">
